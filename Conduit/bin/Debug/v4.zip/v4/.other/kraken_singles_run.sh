...
mkdir #YOURE GONNA HAVE TO MAKE A SCRIPT THAT CALLS A SCRIPT BECAUSE YOU HAVE TO MKDIR /RAW_KRAKEN ONLY ONE TIME -- MAYBE NOT
...
for file in $input/*
do
	kraken --db $DB --threads 12 $output ${input%raw_cleaned*}/raw_kraken
done
