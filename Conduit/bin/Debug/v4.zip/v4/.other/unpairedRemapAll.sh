...
echo
echo "map: bowtie2 -a -x ${outdir}${basename}_index$basename -U $map -p 4 > ${outdir}${basename}.sam"
bowtie2 -a -x ${outdir}${basename}_index$basename -U $map -p 4 > ${outdir}${basename}.sam
